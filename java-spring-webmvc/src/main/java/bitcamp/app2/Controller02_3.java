...
public class Controller02_3 {
  ...
  // 테스트:
  //   http://localhost:8080/java-spring-webmvc/app2/c02_3/h2/hongkildong/010-1111-2222/man
  @GetMapping(value="h2/{name:[a-zA-Z0-9]+}/{tel:[0-9]+-[0-9]+-[0-9]+}/{gender:man|woman}", produces="text/plain;charset=UTF-8")
  // name, tel, gender 값에 정규 표현식으로 지정한 값 외에 입력할 수 없다.
  @ResponseBody
  public String handler2(
    ...
    // 정규 표현식에 어긋난 URL의 경우 예외가 발생할 것이다.

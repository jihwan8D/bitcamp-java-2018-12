...
public class Test14 {
  public static void main(String[] args) throws Exception { 
    ...
    // => 만약 생성자에게 아무것도 넘겨주지 않으면 빈 배열이 생성된다.
    ...
    String s3 = new String(chars); // char 같배열을 String 인스턴스 생성
    ...
    // 한글이 깨진다. 이유?
    // => String 생성자는 파리미터로 받은 바이트 배열에 ISO-8859-1문자 코드가 들어 있다고 간주한다.
    ...
    // 바이트 배열에 들어 잇는 코드는 무슨 문자표로 작성했는지 정확하게 알려줘야 한다.

...
// => SOURCE
//     - 컴파일 할 때 제거된다. .class 파일에 포함되지 않는다.
//    - .class 파일에 포함되지 않는다.
//     - 보통 소스 파일에서 애노테이션 값을 꺼내 다른 파일을 자동 생성하는 도구를 만들 때 많이 사용한다.
// => RUNTIME 
//    - .class 파일까지 유지되고, runtime에 메모리에 로딩돤다.
//     - 실행 중에 Annotation을 참조해야 할 경우에 많이 사용한다.
package ch28.b;

import java.lang.annotation.Annotation;

@MyAnnotation // .class 파일에서 확인 할 수 있다.
@MyAnnotation2 // .class 파일에 없다.
@MyAnnotation3// .class 파일에서 확인 할 수 있다.
public class Test01 {

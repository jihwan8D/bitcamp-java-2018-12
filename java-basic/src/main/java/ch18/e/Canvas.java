...
public class Canvas {
  ...
  // 특정 규칙에 따라 만든 도구를 지정한다.
  // => 이 방식의 장점은 규칙에 따라 만든 도구가 어떤 클래스를 상속 받는지 상관하지 않는다.
  // => 만약 Pen이 인터페이스가 아니라 클래스라면 반드시 Pen의 서브 클래스만 사용해야하 한다.
  //    따라서 클래스를 사용하는 것 보다 인터페이스를 사용하는 것이 훨씬 유연한 코딩을 할 수 있다.
  Pen tool;
  ...
  //   Canvas를 만드는 개발자 입장에서는 훨씬 편리하다.
  //    또한 도구를 만드는 입장에서도 다른 유용한 클래스를 마음껏 상속받아 도구를 만들 수 있어

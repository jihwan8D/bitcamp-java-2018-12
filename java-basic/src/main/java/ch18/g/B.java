// 디폴트 메서드(default method) - 기존 코드에 영향을 미치지 않고 새 규칙을 추가하는 방법
package ch18.g;
...
public interface B {
  ...
  // => 기존 규칙에 새 메서드를 그 규칙에 따라 작성했던 My1과 My2(규칙을 사용했던 클래스들) 클래스에도
  //    새 메서드를 추가해야 한다.
  ...
  // 다음과 같이 새 추상메서드를 추가하면 기존의 My1, My2 클래스에 오류가 발생한다!
  //
  // void m2();

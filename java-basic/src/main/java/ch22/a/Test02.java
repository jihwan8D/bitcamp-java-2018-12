...
public class Test02 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(file.getPath()); // 경로 (생성자에 적은 것 출력됨)
    ...
    System.out.println(file.getTotalSpace()); // HDD 전체 용량
    System.out.println(file.getFreeSpace()); // 빈 용량
    System.out.println(file.getUsableSpace()); // 빈 용량 중 사용할 수 있는 용량
    System.out.println();
    ...
    System.out.println(file.canExecute()); // 실행할 수 있냐
  }

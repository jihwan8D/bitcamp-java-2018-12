...
package design_pattern.abstract_factory.copy;
...
public class Test01 {
  ...
  public static void main(String[] args) {
     ...
     * TerranUnitFactory 클래스: AbstractUnitFactory 구현 클래스. 테란족에 맞춰서 유닛 생성.
     * ProtossanUnitFactory 클래스: AbstractUnitFactory 구현 클래스. 프로토스족에 맞춰서 유닛 생성.
     * ZergUnitFactory 클래스: AbstractUnitFactory 구현 클래스. 저그족에 맞춰서 유닛 생성.
     */
    ...
    switch (type) {
      case 1: 
        ...
        break;
      case 2:
        System.out.println("프토로스족을 선택하셨습니다.");

...
public class Test19 {
  public static void main(String[] args) {
    ...
    //      0000 0001 0000 0111 (여러 프로그래밍 언어에 대해 설정된 값)
    // TypeScript 언어를 할 줄 아는지 검사하기
    //     0000 0000 0001 0111
    //    &0000 0001 0000 0000 (타입스크립트 값을 조사하려는 값과 AND 한다.)
    //--------------------------- (조사하려는 값에 0 비트를 AND 하면 무조건 0으로 만든다.)
    //     0000 0000 0000 0000    (조사하려는 값에 1 비트를 AND 하면 원래 값 그대로 리턴한다.)
    ...
    System.out.printf("TypeScripe : %b\n", (d2 & 0x0100) == 0x0100);
